...
# Subject box
textbox = tk.Text(root, font=('Arial', 15), height=1)
...
def generate_blogpost():
    ...
    blogpost_box.delete("1.0", "end")
    # Inserting response, blogpost.strip() gets rid of empty lines at the beginning being put there by the API
    blogpost_box.insert("1.0", blogpost.strip())
